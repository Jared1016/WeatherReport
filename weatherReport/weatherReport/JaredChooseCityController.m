...
#pragma mark JaredCityGroupCellDelegate
...
//    Jared_EditViewController *JEVC = [[Jared_EditViewController alloc] init];
//    
//    [self.navigationController popToViewController:JEVC animated:YES];
